...
extern const int max_steps; //number of steps of the random walk
extern Eigen::SparseMatrix<double> Q; //Precision matrix
extern std::vector < double > X; //GMRF vector
extern std::vector < int > P; //the vector containing the index of the observed elements of the grid
